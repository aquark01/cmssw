...
void PrimitiveConversion::convert_csc(int pc_sector,
  ...
  // std::cout << "useRun3CCLUT_OTMB_: " << useRun3CCLUT_OTMB_ << " isOTMB: " << isOTMB << std::endl;
  // std::cout << "useRun3CCLUT_TMB_: " << useRun3CCLUT_TMB_ << " isTMB: " << isTMB << std::endl;

  // check if CCLUT is on for this CSC TP
  const bool useRun3CCLUT((useRun3CCLUT_OTMB_ and isOTMB) or (useRun3CCLUT_TMB_ and isTMB));
  // std::cout << "useRun3CCLUT: " << useRun3CCLUT << std::endl;
  if (useRun3CCLUT) {
    // std::cout << "changing pattern to Run 2" << std::endl;
    ...
    // std::cout << "new pattern: " << pattern << std::endl;
  }
  // std::cout << "pattern: " << pattern << " ring: " << tp_ring << std::endl;
  ...
  // Run-3
  // std::cout << "LCT quart eighth: " << tp_data.strip_quart_bit << " " << tp_data.strip_eighth_bit << std::endl;
